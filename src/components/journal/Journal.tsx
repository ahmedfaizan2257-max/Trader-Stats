  ...
  return (
    <div className="space-y-6 max-w-3xl">
      <header>
        ...
        <p className="text-slate-400 mt-1 text-sm">Document your mental state and adherence to the plan.</p>
      </header>
      ...
      <div className="bg-slate-900 border border-slate-800 rounded-2xl p-6 shadow-sm">
        <div className="mb-6 flex items-center justify-between">
          <input 
            ...
            className="bg-slate-950 border border-slate-800 rounded-lg px-4 py-2 text-sm focus:outline-none focus:border-cyan-500 font-mono text-cyan-400"
          />
        ...
        <div className="space-y-8">
                ...
                return (
                  <button
                    ...
                    className={cn(
                      ...
                      followedPlan === opt ? colorClass : "bg-slate-950 text-slate-400 hover:border-slate-600"
                    )}
                  >
                    {opt}
                  </button>
          ...
          <div>
            ...
            <textarea
              ...
              rows={8}
              className="w-full bg-slate-950 border border-slate-800 rounded-xl p-4 text-sm focus:outline-none focus:border-cyan-500 resize-none"
            />
          </div>
